...
class Locations_model extends Crud_Model
{
    ...
    {
        $data = $this->db->select('location_id as id ,title,address1,address2,city,email,phone,province,postal_code,country,pos_api,store_print_ip,kitchen_print_ip,vaughan_location')->order_by('location_id','DSC')->get('locations')->result_array();
