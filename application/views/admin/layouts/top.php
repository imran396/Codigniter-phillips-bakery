<div class="navbar main">
    ...
    <ul class="topnav pull-right">
        ...
        <li class="hidden-phone">
            ...
            <ul class="dropdown-menu pull-right">
                <li class="active"><a href="?page=form_validator&amp;lang=en" title="English"><img src="theme/images/lang/en.png" alt="English"> English</a></li>
                <li><a href="?page=form_validator&amp;lang=ro" title="Romanian"><img src="theme/images/lang/ro.png" alt="Romanian"> Romanian</a></li>
                <li><a href="?page=form_validator&amp;lang=it" title="Italian"><img src="theme/images/lang/it.png" alt="Italian"> Italian</a></li>
                <li><a href="?page=form_validator&amp;lang=fr" title="French"><img src="theme/images/lang/fr.png" alt="French"> French</a></li>
                <li><a href="?page=form_validator&amp;lang=pl" title="Polish"><img src="theme/images/lang/pl.png" alt="Polish"> Polish</a></li>
            </ul>
        </li>
        <li class="account">
