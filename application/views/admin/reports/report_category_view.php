<div id="content">
    ...
    <div class="heading-buttons">
        ...
        <div class="buttons pull-right">
            <a href="/admin/reports/category_orders_csvfile/?start_date=<?php echo isset($_REQUEST['start_date'])?$_REQUEST['start_date']:''; ?>&end_date=<?php echo isset($_REQUEST['end_date'])?$_REQUEST['end_date']:''; ?>" class="btn btn-primary btn-icon glyphicons circle_plus"><i></i>Export CSV</a>
        </div>
        <div class="buttons pull-right">
